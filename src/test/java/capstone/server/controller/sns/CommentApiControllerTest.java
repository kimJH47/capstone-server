...
public class CommentApiControllerTest {
    ...
    @WithMockUser
    @Test
    void 커멘트_삭제_테스트() throws Exception{
        ...
        mockMvc.perform(delete("/comment/"+bucket.getId()).contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(deleteDto))
                .with(csrf())).andExpect(status().isOk());


        Assertions.assertThat(commentRepository.findAll().isEmpty()).isTrue();
    }
